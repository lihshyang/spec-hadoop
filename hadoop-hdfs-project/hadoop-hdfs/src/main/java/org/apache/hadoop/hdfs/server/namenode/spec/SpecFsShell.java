...
public class SpecFsShell extends Configured implements Tool {

  static final Log LOG = LogFactory.getLog(SpecFsShell.class);
   ...
   */
  public SpecFsShell(Configuration conf) {
    super(conf);
  }
  
  protected FileSystem getFS() throws IOException {
    if (fs == null) {
      if (getConf().getBoolean("dfs.namenode.enable.specserver", false)) {
        fs = new SpecBackedFileSystem();
      } else {
  ...
  protected void registerCommands(CommandFactory factory) {
    ...
    if (this.getClass().equals(SpecFsShell.class)) {
  ...
  public static void main(String argv[]) throws Exception {
    SpecFsShell shell = newShellInstance();
    int res;
    try {
  ...
  protected static SpecFsShell newShellInstance() {
    return new SpecFsShell();
  }
